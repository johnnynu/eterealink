...
locals {
  ...
  migration_account_id      = "eterealink-migrate"
  ...
  migration_service_account = "${local.migration_account_id}@${var.project_id}.iam.gserviceaccount.com"
  ...
  api_environment = {
    ...
    ANONYMOUS_UPLOAD_RATE_WINDOW = "1m"
